...
public class NoriAnalysisTests extends ESTokenStreamTestCase {
    ...
    // .build();
    // TestAnalysis analysis = AnalysisTestsHelper.createTestAnalysisFromSettings(settings, null);// new AnalysisNoriPlugin());
    // TokenFilterFactory factory = analysis.tokenFilter.get("my_filter");
    // Tokenizer tokenizer = new KoreanTokenizer();
    ...
    // .build();
    // return AnalysisTestsHelper.createTestAnalysisFromSettings(settings, null);// new AnalysisNoriPlugin());
    // }
}
