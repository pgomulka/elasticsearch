 ...
 */
public class MeteringConstantParser extends AbstractMapListParser implements XContentParser {
    ...
    public MeteringConstantParser(XContentParser xContentParser, AtomicLong counter) {
