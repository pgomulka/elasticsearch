...
public class TestMeterUsages {
    ...
    public TestMeterUsages(MeterRegistry meterRegistry) {
        ...
        meterRegistry.registerDoubleGauge("es.test.double_gauge.count", "test", "unit", doubleWithAttributes::get);
        meterRegistry.registerLongGauge("es.test.long_gauge.count", "test", "unit", longWithAttributes::get);
