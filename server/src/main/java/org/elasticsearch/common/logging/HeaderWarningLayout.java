 ...
 */
public class HeaderWarningLayout extends AbstractStringLayout {
    /**
    ...
    protected HeaderWarningLayout(Charset charset) {
        super(charset);
    }

//    @PluginFactory
    public static HeaderWarningLayout createLayout(Charset charset) {
        return new HeaderWarningLayout(charset);
    }
    ...
    public String toSerializable(LogEvent event) {
        ...
        return formatWarning(formattedMessage);
    }
}
