...
public class RestController implements HttpServerTransport.Dispatcher {
    ...
    private void dispatchRequest(RestRequest request, RestChannel channel, RestHandler handler, Version compatibleVersion)
        ...
        if (contentLength > 0) {
            ...
            if (handler.supportsContentStream() && xContentType != XContentType.JSON && xContentType != XContentType.SMILE && xContentType != XContentType.VND_JSON && xContentType != XContentType.VND_SMILE) {
