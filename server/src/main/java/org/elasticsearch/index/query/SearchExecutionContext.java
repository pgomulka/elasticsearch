...
public class SearchExecutionContext extends QueryRewriteContext {
    ...
    public MappedFieldType buildAnonymousFieldType(String type) {
        ...
        Mapper mapper = builder.build(MapperBuilderContext.ROOT.withIndexName(parserContext.getIndexSettings().getIndex().getName()));
    ...
    MappedFieldType failIfFieldMappingNotFound(String name, MappedFieldType fieldMapping) {
        if (fieldMapping != null || allowUnmappedFields) {
            ...
            return builder.build(MapperBuilderContext.ROOT.withIndexName(indexSettings.getIndex().getName())).fieldType();
        } else {
