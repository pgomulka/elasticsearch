...
public class JavaDateMathParserTests extends ESTestCase {
    ...
    public void testOverridingLocaleOrZoneAndCompositeRoundUpParser() {
        ...
        DateFormatter formatter = DateFormatter.forPattern("8date||epoch_millis").withLocale(randomLocale(random()));
        DateMathParser parser = formatter.toDateMathParser();
        long gotMillis = parser.parse("297276785531", () -> 0, true, (ZoneId) null);
        assertDateEquals(gotMillis, "297276785531", "297276785531");

        formatter = DateFormatter.forPattern("8date||epoch_millis").withZone(ZoneOffset.UTC);
